...
let rev_people = [AAB,ABA,ALH,BEA,BEN,BET,CHL,COR,DOL,FRH,GEG,GOM,GWA,ISP,JHB,JOD,JOJ,JOL,JSU,LAF,MAD,NAG,PAH,PJS,RHL,RIM,ROL,ROM,ROT,THB,THJ,TIP,WFP,WLH];
...
let cw_people = [ABL,DSL,DUF,EKS,FEA,FRD,GBM,HBS,HWH,JEB,JED,JJT,JML,JOS,JPJ,LUL,MBC,MTL,PGB,REL,ROA,ROG,SMD,USG,WTS];
