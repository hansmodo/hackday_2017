...
(function(){
  ...
  * e.g. document.body
  */
  function findTextInNode(node, regex){
    //console.log("content_context findTextInNode");
  ...
  chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
      ...
      if(request.plugin === 'load'){
        ...
        findTextInNode(document.body, peopleRegex);
      }
  });
